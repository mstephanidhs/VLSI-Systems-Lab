...
module rca ( a_i, b_i, sum_o );
  ...
  INVxp33_ASAP7_75t_R U17 ( .A(n15), .Y(n12) );
  INVxp33_ASAP7_75t_R U18 ( .A(n14), .Y(n13) );
  INVxp33_ASAP7_75t_R U19 ( .A(n16), .Y(n11) );
  NAND2xp33_ASAP7_75t_R U20 ( .A(a_i[0]), .B(b_i[0]), .Y(n16) );
  OA21x2_ASAP7_75t_R U21 ( .A1(a_i[0]), .A2(b_i[0]), .B(n16), .Y(
        \fas[0].fa/N0 ) );
  MAJIxp5_ASAP7_75t_R U22 ( .A(b_i[1]), .B(a_i[1]), .C(n11), .Y(n15) );
  MAJIxp5_ASAP7_75t_R U23 ( .A(b_i[2]), .B(a_i[2]), .C(n12), .Y(n14) );
